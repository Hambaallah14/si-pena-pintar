...
class MWidyaiswara extends CI_Model{
    ...
    public function allWidyaiswara(){
      return $this->db->query("SELECT tb_widyaiswara.nip_wi, tb_widyaiswara.nama, tb_widyaiswara.no_telp, tb_login.status_user FROM tb_widyaiswara INNER JOIN tb_login ON tb_widyaiswara.nip_wi=tb_login.id_user")->result_array();
    }
